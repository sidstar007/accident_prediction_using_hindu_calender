...
function panchangCallback(date) {
  /*console.log("Panchang Details for the Input Date and Time:");
  console.log("Day:", panchang.Day.name);
  console.log("Tithi:", panchang.Tithi.name, "from", panchang.Tithi.start, "to", panchang.Tithi.end);
  console.log("Nakshatra:", panchang.Nakshatra.name, "from", panchang.Nakshatra.start, "to", panchang.Nakshatra.end);
  console.log("Karna:", panchang.Karna.name, "from", panchang.Karna.start, "to", panchang.Karna.end);
  console.log("Yoga:", panchang.Yoga.name, "from", panchang.Yoga.start, "to", panchang.Yoga.end);
...
//panchang.calculate(currentDate, panchangCallback);
...
function saveToCSV(csvData, newData) {
    ...
    fs.writeFileSync('./dataset/accidents_by_date.csv', newCSV.join('\n'));
}
...
async function readCSVFile(filePath) {
    try {
        ...
        csvData.forEach(element => {
            ...
            //console.log(dateString)
            panchang.calculate(dateString,()=>panchangCallback(element.Date) );
